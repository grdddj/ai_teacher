    ...
    <div class="bg-white shadow-sm border-b border-slate-200">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-3xl font-bold text-slate-900">Group Management</h1>
            <p class="text-slate-600 mt-1">Create and manage student groups</p>
          </div>
          <NuxtLink
            to="/"
        ...
        <form class="space-y-6" @submit.prevent="createGroup">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="e.g., solve independently 3 different quadratic equations of type ax² + bx + c using discriminant"
              required
              rows="3"
